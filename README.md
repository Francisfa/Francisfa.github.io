...
> 下面是博客的搭建教程，foking自 [qiubaiying](http://qiubaiying.github.io), 这个[教程](http://www.jianshu.com/p/e68fba58f75c)修改自 [Hux](https://github.com/Huxpro/huxpro.github.io) 。

### [我自己按照教程改写的博客 &rarr;](http://francisfa.github.io)
...
> 这里我没有安装，所以我是在markerdown编辑器里写好，然后再上传，一般格式就OK，也不用多加修改。
...
SEOTitle: 名字的博客 | XX Blog		# SEO 标题
description: "I am cool."	   	   # 随便说点，描述一下
...
Jekyll官方网站还有很多的参数可以调，比如设置文章的链接形式...网址在这里：[Jekyll - Official Site](http://jekyllrb.com/).
> 可以自己在[Jekyll中文](http://jekyllcn.com/)学习下，这个在熟悉后可以设置自己博客的特色。
...
```
> 我虽然注册了，但是没使用，因为这个的评论系统是需要翻墙的，速度很慢！
...
参考原作者的这篇文章：[《为博客添加 Gitalk 评论插件》](http://qiubaiying.top/2017/12/19/%E4%B8%BA%E5%8D%9A%E5%AE%A2%E6%B7%BB%E5%8A%A0-Gitalk-%E8%AF%84%E8%AE%BA%E6%8F%92%E4%BB%B6/)
> 这里我也没设置，抽点时间研究一下吧，估计也没人评论，不过也就是学习一下！
...
ga_domain: auto		# 默认的是 auto, 可以写自定义了的域名，你如果没有自己的域名，需要改成auto。
```
